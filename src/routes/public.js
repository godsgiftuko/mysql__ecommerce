...
router.post("/checkout/3", Auth.ensureAuthenticated, publicController.validatePayment);
router.post("/checkout/4", Auth.ensureAuthenticated, publicController.confirmOrder);
